...
| Day | Time | Content |
|-----|------|---------|
| **Day 2** | Morning | Basic syntax, pattern notation |
| **Day 2** | Afternoon | Sample manipulation, effects processing |
| **Day 3** | Morning | Advanced pattern manipulation, randomness |
| **Day 3** | Afternoon | Original music production, live performance |
